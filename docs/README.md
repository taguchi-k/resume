...
- iOS ネイティブアプリ開発・設計
- Flutter Web を用いたモバイル向け Web アプリ開発・設計
- React / TypeScrip を用いた Web アプリ開発・設計
...
- iOS ネイティブアプリの開発を得意としています
- 現在は Flutter Web を用いたモバイル向け Web アプリ開発を行っています
- 上記と並行して React / TypeScript による Web フロントエンドの開発業務も行っています
- バックエンドへの興味もあります
...
#### トレタ O/X スタッフ用コンソール Web アプリ 開発・運用（2021/6〜現在）
...
#### トレタ O/X toC モバイルオーダーサービス Web アプリ 開発・運用（2020/12〜現在）
